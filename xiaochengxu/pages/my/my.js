...
var HeadInfo = function HeadInfo() {
  __webpack_require__.e(/*! require.ensure | pages/my/components/headInfo */ "pages/my/components/headInfo").then((function () {
    return resolve(__webpack_require__(/*! ./components/headInfo.vue */ 269));
...
var OrderList = function OrderList() {
  Promise.all(/*! require.ensure | pages/my/components/orderList */[__webpack_require__.e("common/vendor"), __webpack_require__.e("pages/my/components/orderList")]).then((function () {
    return resolve(__webpack_require__(/*! ./components/orderList.vue */ 276));
  }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};
...
var _default = {
  ...
  computed: {
    ...
    psersonUrl: function psersonUrl() {
  ...
  methods: _objectSpread(_objectSpread({}, (0, _vuex.mapMutations)(['setAddressBackUrl', 'setBaseUserInfo'])), {}, {
    openProfileEditor: function openProfileEditor() {
      this.profileEditorVisible = true;
    },
    closeProfileEditor: function closeProfileEditor() {
      if (!this.profileSaving) this.profileEditorVisible = false;
    },
    saveProfile: function saveProfile(_ref) {
      var _this = this;
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
        var name, tempAvatarPath, currentAvatar, avatar, uploadResult, response, profileData;
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                name = _ref.name, tempAvatarPath = _ref.tempAvatarPath, currentAvatar = _ref.currentAvatar;
                if (!_this.profileSaving) {
                  _context.next = 3;
                  break;
                }
                return _context.abrupt("return", false);
              case 3:
                _this.profileSaving = true;
                _context.prev = 4;
              ...
              case 13:
                ...
                (0, _session.persistSession)(_this.$store, profileData);
                _this.profileEditorVisible = false;
                return _context.abrupt("return", true);
              case 20:
                _context.prev = 20;
                _context.t0 = _context["catch"](4);
                uni.showToast({
                  title: (0, _errorMessage.getErrorMessage)(_context.t0, '资料保存失败，请重试'),
                  icon: 'none'
                });
                return _context.abrupt("return", false);
              case 24:
        ...
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                page = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : _this2.pageInfo.page;
                if (!_this2.loading) {
                  _context2.next = 3;
                  break;
                }
              ...
              case 3:
                ...
                return (0, _api.getOrderPage)({
                  pageSize: _this2.pageInfo.pageSize,
                  page: page
                });
              case 7:
                res = _context2.sent;
              ...
              case 10:
                ...
                _this2.failedPage = null;
                _this2.pageInfo.page = page;
                _this2.pageInfo.total = Number(data.total) || 0;
                _this2.loadingText = '';
                return _context2.abrupt("return", true);
              case 20:
                _context2.prev = 20;
                _context2.t0 = _context2["catch"](4);
                _this2.failedPage = page;
                _this2.loadingText = (0, _errorMessage.getErrorMessage)(_context2.t0, '订单加载失败，请重试');
                uni.showToast({
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 22:
                ...
                uni.showToast({
                  title: (0, _errorMessage.getErrorMessage)(_context3.t0, '再来一单失败，请重试'),
                  icon: 'none'
                });
        ...
        return _regenerator.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                if (!(_this3.failedPage !== null)) {
                  _context4.next = 5;
                  break;
                }
                _this3.loadingText = '数据加载中…';
                return _context4.abrupt("return", _this3.getList(_this3.failedPage));
              case 5:
                totalPages = Math.ceil(_this3.pageInfo.total / _this3.pageInfo.pageSize);
                if (!(_this3.pageInfo.page >= totalPages)) {
                  _context4.next = 9;
                  break;
                }
                if (_this3.recentOrdersList.length) _this3.loadingText = '没有更多了';
                return _context4.abrupt("return", false);
              case 9:
                _this3.loadingText = '数据加载中…';
                return _context4.abrupt("return", _this3.getList(_this3.pageInfo.page + 1));
              case 11:
              case "end":
